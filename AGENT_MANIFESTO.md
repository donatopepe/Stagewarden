...
- Maintain a minimum operational baseline comparable to Codex CLI, Claude Code, and KiloCode for shell UX, status surfaces, model/account control, permissions, handoff/resume, file/git tools, and extensibility.
