...
- `/role assign` apre un menu guidato, oppure `/role assign <node_id> <provider> <provider_model> [reasoning_effort=<valore>] [account=<nome>]` assegna un provider-model a un nodo specifico dell'albero.
