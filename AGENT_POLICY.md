...
### 13. Codex CLI, Claude Code, and KiloCode Minimum Baseline

- Stagewarden must maintain a minimum practical capability baseline comparable to Codex CLI, Claude Code, and KiloCode.
