...
- Next planned slices: v3.3 compaction policy modes, v3.4 deterministic retrieval-quality benchmark harness, v3.5 policy defaults by phase/role for `min_score`.
