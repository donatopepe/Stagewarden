...
- The repository is on branch `main`; the current active slice is the validated research/report/plan evidence-gate follow-up, ready to be committed with the aligned handoff updates.
