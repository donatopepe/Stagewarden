...
- Next planned slices: v3.2 retrieval diagnostics (lexical/vector contribution), v3.3 compaction policy modes, v3.4 deterministic retrieval-quality benchmark harness.
