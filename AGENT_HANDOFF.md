...
- `stagewarden/command_views.py` now owns the shell/git/file/session/patch/permission command cluster that was still living in `main.py`.
...
- `stagewarden/project/design_flow.py`: extracted the project design packet/report helpers out of `main.py`.
