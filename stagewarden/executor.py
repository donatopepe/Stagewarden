...
class Executor:
    ...
    def _prince2_node_context_packet(self, task: str, step: PlanStep) -> str:
        ...
        lines = [
            ...
            "- communication_commands: roles messages [node_id] | role message <source_node> <target_node> <edge_id> payload=<scope1,scope2> | role wait <node_id> reason=<text> | role wake <node_id> trigger=<name> | role tick <node_id> | roles tick [max_nodes]",
