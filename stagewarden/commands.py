...
COMMAND_SPECS: tuple[CommandSpec, ...] = (
    ...
    CommandSpec("rag benchmark", "core", "Run deterministic RAG retrieval quality benchmark.", "rag benchmark [baseline=<path>] [threshold=0.05] [write=<path>]", json=True, handler="rag"),
