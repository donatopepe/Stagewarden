...
COMMAND_SPECS: tuple[CommandSpec, ...] = (
    ...
    CommandSpec("catalog", "models", "Refresh, inspect, or search the AI model catalog snapshot.", "catalog <status|refresh|search>", aliases=("catalog search <query> [provider=<provider>] [feature=<feature>]",), json=True, handler="models"),
